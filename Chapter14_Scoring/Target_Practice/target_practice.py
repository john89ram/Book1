# 14-2 Target Practice
    # Create a rect at the right edge of the screen that moves up and down (y)
    # Create a ship on the left side that the player can control and fire bullets
    # Add a play button that starts the game
        # If the player misses the target 3 times the game ends
        # Make the "Play" button reappear when game is over and reset the game
